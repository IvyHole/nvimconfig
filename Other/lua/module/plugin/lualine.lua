...
local lualine_plugin = {
    ...
    config = function()
		...
		local icons = {
			diagnostics = require("module.utils.icons").get("diagnostics", true),
			git = require("module.utils.icons").get("git", true),
			git_nosep = require("module.utils.icons").get("git"),
			misc = require("module.utils.icons").get("misc", true),
			ui = require("module.utils.icons").get("ui", true),
		}
